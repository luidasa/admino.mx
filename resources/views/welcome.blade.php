            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 text-center" data-aos="fade">
                        ...
                        <p class="page-header-text">Build a marketing site for your desktop app with this easy to use layout included with SB UI Kit Pro</p>
    ...
    <section class="bg-white py-10">
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6">
                    <div class="badge badge-primary-soft text-primary badge-marketing badge-pill mb-3">Get Started!</div>
                    <div class="mb-5">
                ...
                <div class="col-md-9 col-lg-6" data-aos="slide-left">
                    <div class="mb-4">
                        <div class="content-skewed content-skewed-left"><img class="img-fluid content-skewed-item shadow-lg rounded-lg" src="assets/img/app-desktop-demo-screenshot.jpg" /></div>
                    </div>
                </div>
            </div>
        </div>
