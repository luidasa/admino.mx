    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        <li class="nav-item {{ Route::currentRouteName() == 'inicio' ? 'active': '' }}">
          <a class="nav-link " aria-current="page" href="{{route('inicio')}}">Panel</a>
        </li>
        <li class="nav-item {{ Route::currentRouteName() == 'condominos' ? 'active': '' }}">
          <a class="nav-link" href="{{route('condominos')}}">
            Condominos
          </a>
        </li>
        <li class="nav-item {{ Route::currentRouteName() == 'pagos' ? 'active': '' }}">
          <a class="nav-link" href="{{route('pagos')}}">
            Pagos
          </a>
        </li>
        <li class="nav-item {{ Route::currentRouteName() == 'quejas' ? 'active': '' }}">
          <a class="nav-link" href="{{route('quejas')}}">
            Quejas
          </a>
        </li>
        <li class="nav-item {{ Route::currentRouteName() == 'documentos' ? 'active': '' }}">
